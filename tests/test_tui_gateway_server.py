...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted: ["kanban", "legal", "memory"]. `kanban` is auto-recovered by
    # _get_platform_tools because it's a non-configurable platform toolset
    # whose tools live in hermes-cli's universe (see toolsets.py); `legal` is
    # recovered because the QDRO backstory tool is part of the shared core set.
    assert server._load_enabled_toolsets() == ["kanban", "legal", "memory"]
